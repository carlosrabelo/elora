...
void Engine::clear(std::uint32_t /*color*/) {
    // scaffold: drawing lands in a later commit
}
...
void Engine::stroke_triangle(int /*x0*/, int /*y0*/, int /*x1*/, int /*y1*/, int /*x2*/, int /*y2*/,
                             std::uint32_t /*color*/) {
    // scaffold: drawing lands in a later commit
}

void Engine::fill_triangle(int /*x0*/, int /*y0*/, int /*x1*/, int /*y1*/, int /*x2*/, int /*y2*/,
                           std::uint32_t /*color*/) {
    // scaffold: drawing lands in a later commit
}
